...
from lib.tcp_test import tcp_server
...
class Run(object):
    def __init__(self, parameters, opt):
        ...
        self.share_var_4 = torch.multiprocessing.Manager().dict()
        self.share_var_5 = torch.multiprocessing.Manager().Queue()

        self.share_var_6 = torch.multiprocessing.Manager().dict()
        self.share_var_8 = torch.multiprocessing.Manager().dict()
        ...
        self.share_lock_6 = torch.multiprocessing.Manager().Lock()
        self.share_lock_8 = torch.multiprocessing.Manager().Lock()
    ...
    def tcp_start(self, share_var, share_var_1, share_var_4, share_var_6, share_var_8, share_lock, share_lock_1, share_lock_4, share_lock_6,  share_lock_8):
        tcp_server(share_var, share_var_1, share_var_4, share_var_6, share_var_8, share_lock, share_lock_1, share_lock_4, share_lock_6,  share_lock_8)
    ...
    def get_process_list(self):
        ...
        tcp_process = torch.multiprocessing.Process(target=self.tcp_start,
                                                    args=(self.share_var, self.share_var_1, self.share_var_4,
                                                          self.share_var_6, self.share_var_8, self.share_lock,
                                                          self.share_lock_1, self.share_lock_4, self.share_lock_6, self.share_lock_8))
        process_list.append(tcp_process)

        stream_process = torch.multiprocessing.Process(target=streaming,
                                                       args=(self.share_var, self.share_var_1, self.share_var_4,
                                                             self.share_var_5, self.share_var_6, self.share_var_8, self.share_lock, self.share_lock_1,
                                                             self.share_lock_4, self.share_lock_6, self.share_lock_8, self.parameters, self.opt))
        ...
        if self.parameters.live:
            live_process = torch.multiprocessing.Process(target=streaming_plug,
                                                         args=(self.share_var, self.share_lock, self.share_var_5, self.share_var_6, self.share_lock_6, self.share_var_8, self.share_lock_8,
                                                               self.parameters))
