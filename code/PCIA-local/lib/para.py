...
class Parameters(object):
    def __init__(self, macAddress, rtmpIP=''):
        ...
        self.parser.add_argument('--resultNum', type=str, default='0')
    def parse(self, args=''):
        if args == '':
        ...
        parameter.camera_path = 'rtsp://admin:guocheng660@192.168.1.64/Streaming/Channels/101'
        # parameter.camera_path = './video/test2.mp4'
        parameter.fps = 20
